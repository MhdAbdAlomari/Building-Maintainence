...
class AssignedRequestsRelationManager extends RelationManager
{
    protected static string $relationship = 'assignedRequests';
    protected static ?string $title = 'Assigned Requests';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('title')->limit(26)->searchable(),
                ...
                Tables\Columns\TextColumn::make('final_price_syp')->label('Final')->numeric(),
